...
const BACKEND_URL = 'https://nodejs-serverless-function-express-bice-six.vercel.app'; // This will be updated with ngrok URL when testing publicly
...
const CORRECT_SYMBOL = '🟢';   // Green circle for correct guess
const VERY_CLOSE_SYMBOL = '🟡'; // Yellow circle for very close
const SOMEWHAT_CLOSE_SYMBOL = '🟠'; // Orange circle for somewhat close
const NOT_CLOSE_SYMBOL = '🔴';   // Red circle for not close
const UNUSED_SLOT_SYMBOL = '⚫'; // Black circle for unused slots
...
async function handleSubmitGuess() {
    ...
    if (userGuess === correctAnswer.toLowerCase()) {
        ...
        messageDiv.textContent = `🎉 Correct! You guessed "${correctAnswer}" in ${currentGuessCount} tries!`;
